...
const allowedOrigins = [
    ...
    "https://careersyncplatformmsr.vercel.app",  // CareerSync Production (Vercel)
    "http://localhost:5173",
    "http://127.0.0.1:5173",
    "http://localhost:5174",
    "http://127.0.0.1:5174"
...
const { companyPostRouter } = require('./routes/CompanyRoutes/companyPostRoutes')
...
app.use('/api/v1/company-posts', companyPostRouter)
